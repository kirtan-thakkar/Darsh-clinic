  ...
  const teamMembers = [
    {
      ...
      fullBio: "Dr. Dhiraj Nayak is the visionary founder of Darsh Dental Clinic, established in 2008 with a mission to provide world-class dental care with a personal touch. With over 20 years of dedicated service to the Vadodara community, Dr. Nayak has built a reputation for clinical excellence, innovative treatments, and compassionate patient care. His approach combines cutting-edge dental technology with traditional values of trust, integrity, and personalized attention. Under his leadership, Darsh Dental has grown from a single clinic to a network of three state-of-the-art facilities, serving over 10,000 satisfied patients. Dr. Nayak specializes in general and cosmetic dentistry, with particular expertise in smile makeovers, dental implants, and complex restorative procedures.",
      education: [
