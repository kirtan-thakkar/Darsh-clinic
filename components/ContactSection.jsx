        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              Take the first step towards your perfect smile. Schedule your consultation today 
              and discover how we can transform your oral health.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">123 Dental Street, Health City</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Mon-Fri: 8AM-6PM, Sat: 9AM-3PM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 px-8 rounded-lg font-medium transition-colors"
              >
